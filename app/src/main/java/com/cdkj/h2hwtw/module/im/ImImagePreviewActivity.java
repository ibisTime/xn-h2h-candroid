...
import com.cdkj.h2hwtw.databinding.ActivityImagePreviewBinding;
 ...
 * 聊天图片拍摄预览
 */
public class ImImagePreviewActivity extends AbsBaseLoadActivity {
    ...
    public void afterCreate(Bundle savedInstanceState) {
        mBaseBinding.titleView.setMidTitle("图片预览");
        mBaseBinding.titleView.setRightTitle("发送");
    ...
    private void showImage() {
        ...
        ImgUtils.loadImgNoPlaceholder(this, path, mBinding.image);
