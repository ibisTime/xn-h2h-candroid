...
public class ChatAdapter extends ArrayAdapter<Message> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView != null) {
            ...
            viewHolder.leftLogo = (ImageView) view.findViewById(R.id.leftAvatar);
            viewHolder.rightLogo = (ImageView) view.findViewById(R.id.rightAvatar);
            view.setTag(viewHolder);
        }
        if (position < getCount()) {
            final Message data = getItem(position);
            ImgUtils.loadLogo(getContext(), data.getLeftLogo(), viewHolder.leftLogo);
            ImgUtils.loadLogo(getContext(), data.getRightLogo(), viewHolder.rightLogo);
